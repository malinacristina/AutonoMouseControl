...
class ExperimentWorker(QtCore.QObject):
    ...
    def get_present_animal(self):
        ...
        animal = rfid.check_rfid(self.hardware_prefs['rfid_port'], 16)
        print(animal)
    ...
    def reward(self, animal):
        ...
        reward.deliver_reward("Mod2/ai0", self.hardware_prefs['analog_output'], self.hardware_prefs['sync_clock'],
